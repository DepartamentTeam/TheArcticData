...
// },
 ...
 // },
 {
  ...
  {
    id: 7,
    label: "Результат Исслеодования: Районы",
    value: "districts_result",
  },
  {
    id: 8,
    label: "Результат Исследования: Населенные пункты",
...
export const LayerSelector = () => {
  ...
  return (
    <div className="tooltips-bar__map">
            <span className="tooltips-bar__map-title subtitle-1">{layers_icons} Слои</span>
          ...
          <button className="btn btn--secondary btn--outlined"
          onClick={clearLayers}>
            Очистить
          </button>
    </div>
