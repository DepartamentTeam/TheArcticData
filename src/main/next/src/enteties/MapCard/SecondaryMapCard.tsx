...
import { RoundFloat } from "./MapCard"
...
export const SecondaryMapCard = () => {
  ...
  return (
    <section className="map-card--secondary">
      {props?.iden_access_100 &&  props?.iden_access_100 !== 0 ? (
      ...
      {props?.integral_rate_ter_access &&  props?.integral_rate_ter_access !== 0 ? (
        <div className="map-card__col">
          {" "}
      ...
      {props?.rate_ter_access_duration && props?.rate_ter_access_duration !== 0 ? (
            <div className="map-card__col">
          ...
          {props?.rate_ter_access_distance &&  props?.rate_ter_access_distance !== 0 ?(
            <div className="map-card__col">
      ...
      {props?.iden_integral_rate_ter_access && props?.iden_integral_rate_ter_access !== 0 ? (
          <div className="map-card__col">
            {" "}
            <strong>
              {RoundFloat(
